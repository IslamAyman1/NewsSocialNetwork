                ...
                <div class="col-md-6 tn-left">
                    <div class="row tn-slider">
                        @foreach($latest_three_posts as $post)
                            <div class="col-md-6">
                                <div class="tn-img">
                                    <img style="height:383px;width:510px" src="{{$post->images->first()->path}}" />
                                    <div class="tn-title">
                ...
                <div class="col-md-6 tn-right">
                    ...
                    <div class="row">
                        @foreach($four_posts as $post)
                            <div class="col-md-6">
                                <div class="tn-img">
                                    <img style="height: 165px;width:300px " src="{{asset($post->images->first()->path)}}" />
                                    <div class="tn-title">
                                        <a href="{{route('frontend.post.show',$post->slug)}}">{{$post->title}}</a>
                                    </div>
                                </div>
                        ...
                        <div id="popular" class="container tab-pane fade">
                            @foreach($greatest_posts_comment as $post)
                                <div class="tn-news">
                                    ...
                                    <div class="tn-title">
                                        <a href="{{route('frontend.post.show',$post->slug)}}">{{$post->title}} <br> ({{$post->comments_count}} Comment)</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div id="m-read" class="container tab-pane fade">
                             @foreach($gretest_posts_views as $post)
                                <div class="tn-news">
                                    ...
                                    <div class="tn-title">
                                        <a href="{{route('frontend.post.show',$post->slug)}}">{{$post->title}} <br>({{$post->num_of_views}} View)</a>
                                    </div>
                                </div>
                             @endforeach
                     </div>
